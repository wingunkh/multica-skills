...
- 기관을 원문에서 판단할 수 없으면 `[미확인]`을 쓴다.

좋은 예:
```
[문화] 서버접근제어 내 유지보수 담당자 계정 추가 및 전달
[보건] 배포 프로세스 관련 문의
...
## 예시
아래 예시들은 읽기 쉽도록 블록 사이 `&nbsp;` 줄을 생략했다. 실제 출력에서는 예시와 달리 모든 블록 사이에 `빈 줄 → &nbsp; → 빈 줄`을 반드시 넣는다.
...
원본 폴더
경로: D:\pdfconv\srcdoc\2026\8\12\DOC2026081200123
폴더: 생성·수정 2026-08-12 15:43:58
DOC2026081200123_001.hwp (139,776 bytes) 생성·수정 2026-08-12 15:43:58 / 액세스 2026-08-12 15:43:59
DOC2026081200123_002.hwp (121,344 bytes) 생성·수정·액세스 2026-08-12 15:43:58
변환 폴더
경로: D:\pdfconv\pdfout\2026\8\12\DOC2026081200123
폴더: 생성·수정 2026-08-31 14:43:43
폴더 내 파일: 없음 (숨김 파일 포함)
확인 불가 범위
...
출력:
```
제목: [문화] 서버접근제어 내 유지보수 담당자 계정 추가 및 전달
처리 상태: 완료
